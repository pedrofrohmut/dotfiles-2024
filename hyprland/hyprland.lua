...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("wlsunset -T 5700 -t 3500 -g 1.0 -S 06:00 -s 19:00")

    -- Status Bar
    hl.exec_cmd("waybar")

    -- Desktop Background
    hl.exec_cmd("swaybg -i $HOME/media/wallpaper/1332407.png -m stretch")
end)
...
hl.config({
    general = {
        ...
        col = {
            ...
            active_border   = "#cecece",
            -- inactive_border = "rgba(595959aa)",
            inactive_border = "#343434",
        },
...
hl.bind(mainMod .. " + y", hl.dsp.exec_cmd(menu))
